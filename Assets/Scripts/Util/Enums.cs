namespace Assets.Scripts.Util
{
    ...
    {
        public enum Arrows { Normal, Fireball, Ice, Thunder, Acid, Ricochet, Ghost, Gravity, Tracking, NumTypes };
        public enum Tokens { Fireball, Ice, Thunder, Acid, Ricochet, Ghost, Gravity, Tracking, Health, NumTypes };
