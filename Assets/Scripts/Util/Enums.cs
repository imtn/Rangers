namespace Assets.Scripts.Util
{
    ...
    {
        public enum Arrows { Normal, Fireball, Ice, Thunder, Acid, Ricochet, Ghost, Gravity, Lifesteal, Virus, NumTypes };
        public enum Tokens { Fireball, Ice, Thunder, Acid, Ricochet, Ghost, Gravity, Lifesteal, Virus, Health, NumTypes };
