namespace Assets.Scripts.Util
{
    ...
    {
        public enum Arrows { Normal, Fireball, Ice, Thunder, Acid, Ricochet, Ghost, Gravity, Tracking, Lifesteal, NumTypes };
        public enum Tokens { Fireball, Ice, Thunder, Acid, Ricochet, Ghost, Gravity, Tracking, Lifesteal, Health, NumTypes };
